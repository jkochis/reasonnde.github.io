    ...
    switch (_type) {
       /* case 'image':
        ...
        case 'slideshow':
           ...
           // _lightbox.find('.send').data('subject', _share.subject);
           // _lightbox.find('.send').data('desc', _share.desc);
			_lightbox.find('.facebook').html('<a href="https://www.facebook.com/sharer/sharer.php?https://www.slideshare.net/slideshow/embed_code/'+_id+'?rel=0'+'"><div class="icon"></div></a>');
			_lightbox.find('.twitter').html('<a href="https://twitter.com/home?status=https://www.slideshare.net/slideshow/embed_code/'+_id+'?rel=0'+'"><div class="icon"></div></a>');
			_lightbox.find('.googleplus').html('<a href="https://plus.google.com/share?url=https://www.slideshare.net/slideshow/embed_code/'+_id+'?rel=0'+'"><div class="icon"></div></a>');
...
*/
$('.icon-search-chart, .slide-pop').on('click',function(e){
    var _share = {};
	_analytics = $(this).siblings('.icon-send').attr('onmousedown');
	//console.log(_analytics);
    _share.desc = $(this).parent().parent().data('desc');
    _share.subject = $(this).parent().parent().data('subject');
    launchLightbox('slideshow',$(this).parent().parent().data('id'),_share, $(this).parent().parent().data('download'));
